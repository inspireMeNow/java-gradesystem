  ...
  <div class="regist-body">
    ...
    <div class="regist-body-content">
      ...
      <div class="body-content-list">
        ...
        <script>
          document.getElementById("Urole").value=${requestScope.Urole};
        </script>
      </div>
      <div class="body-content-list">
...
<script>
  function sendEmail(){
    ...
    form.action = "userServlet?action=sendEmail";
    form.method = "POST";
    form.innerHTML = '<input name="email" value="'+email+'">'+'\n'+'<input name="universityId" value="'+universityId+'">'+'\n'+'<input name="Urole" value="'+Urole+'">';
    document.body.append(form);
    form.submit();
    document.getElementById("chksend").innerHTML="<font color=green>邮件发送成功</font>";
  }
  function chkPwd(obj){
    var t=obj.value;
    var id=getResult(t);
